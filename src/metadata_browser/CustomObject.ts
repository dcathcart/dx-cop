import { AnyJson, getString, getJsonMap } from '@salesforce/ts-types';
...
export class CustomObject extends ComponentBase {
  ...
  private get customSettingsType(): string {
    return getString(this.topLevelNode, 'customSettingsType');
  }

  private get topLevelNode(): AnyJson {
    return getJsonMap(this.metadata, 'CustomObject');
  }
}
